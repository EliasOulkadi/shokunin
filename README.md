...
> 職人 (shokunin) means artisan in Japanese. Someone who takes pride in every detail.

## Domains

- **Backend** (5): api-forge, auth-architect, db-sculptor, test-commander, error-handler
- **Frontend** (4): component-forge, landing-craft, responsive-engine, motion-craft
...
Each skill is a directory with a SKILL.md file containing YAML frontmatter (name, description) and markdown content.
