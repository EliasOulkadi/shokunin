...
| "象限图 / quadrant / 优先级矩阵 / 2x2 matrix" | Quadrant | `assets/diagrams/quadrant.html` |
...
- 2x2 layouts: use `table.t2x2`, not CSS Grid
...
- Content follows `writing.md`: data over adjectives, distinctive phrasing over industry cliches
